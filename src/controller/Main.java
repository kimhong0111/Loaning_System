...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        system.createApplicant("John Doe", "john123", "0123456789", "password1", 30, 5000, "M");
        system.createApplicant("Jane Smith", "jane123", "0987654321", "password2", 28, 6000, "F");
        system.createStaff("Jeff", "Jeff123", "0111111111", 40, "1234", 10000, LoaningSystem.LOAN_OFFICER);
        system.createStaff("Bob LoanOfficer", "bobL123", "0987654321", 30, "password4", 5000, LoaningSystem.CREDIT_COMMITTEE);
